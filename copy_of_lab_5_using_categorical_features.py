# -*- coding: utf-8 -*-
"""Copy of Lab 5: Using Categorical Features.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xZgokQGmvfT0M6-Opzlsp9wfo-SlLrNG
...
def construct_feature_columns():
  ...
  body_style = tf.contrib.layers.sparse_column_with_hash_bucket(
      "body-style", hash_bucket_size=10)
  
  return [drive_wheels, make, price, highway_mpg, body_style]
...
def construct_feature_columns():
  ...
  fuel_type = tf.contrib.layers.sparse_column_with_keys(
      column_name="fuel-type", keys=["gas", "diesel"])
  horsepower = tf.contrib.layers.real_valued_column("horsepower")
  
  return [drive_wheels, make, price, fuel_type, horsepower]
...
def construct_feature_columns():
  ...
  fuel_system = tf.contrib.layers.sparse_column_with_keys(
      column_name="fuel-system", keys=["gas", "diesel"])
  body_style = tf.contrib.layers.sparse_column_with_hash_bucket(
      "body-style", hash_bucket_size=10)
  
  return [drive_wheels, make, price, fuel_system, body_style]
