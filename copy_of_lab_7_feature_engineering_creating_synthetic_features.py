# -*- coding: utf-8 -*-
"""Copy of Lab 7: Feature Engineering - Creating Synthetic Features.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1p0TmEz4kA7YJQcotVx6X1Avl8_Rp6roD
...
def prepare_features(dataframe):
  ...
  processed_features["households_per_person"] = (
    dataframe["households"] / dataframe["population"])
  processed_features["bedrooms_per_person"] = (
    dataframe["total_bedrooms"] / dataframe["population"])
...
NUMERICAL_COLUMNS = ["latitude", "longitude", "housing_median_age", 
                     "total_rooms", "total_bedrooms", "population",
                     "households", "median_income", "rooms_per_person", "bedrooms_per_person", "households_per_person"]
...
"""[link text](https://)You can use this function to draw a histogram to help decide what kind of scaling is best to use for `households` and also to confirm your implementation of `clip` works as you intended."""
...
draw_histograms(training_examples, 'total_rooms')

print "Now let's clip between 0 and 1000 before scaling."

draw_histograms(training_examples, 'total_rooms', 0, 1000)
...
def prepare_features(dataframe):
  ...
  processed_features["households_per_person"] = (
    linear_scale(dataframe["households"] / dataframe["population"]))
  processed_features["bedrooms_per_person"] = (
    linear_scale(dataframe["total_bedrooms"] / dataframe["population"]))
...
NUMERICAL_FEATURES = ["total_rooms", "bedrooms_per_person", "households_per_person"]
LABEL = "median_house_value"
