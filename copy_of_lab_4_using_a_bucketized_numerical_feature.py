# -*- coding: utf-8 -*-
"""Copy of Lab 4: Using a Bucketized Numerical Feature.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Mz9kQgvaGhaprMBRDTKxcUVKPlHl1Tnz
...
The learning rate is neither too high nor too low. There is no change in loss after some periods, so it is a good learning rate.
"""
...
def prepare_features(dataframe):
  ...
  for features in NUMERICAL_FEATURES:
    processed_features[features] = linear_scale(processed_features[features])
  return processed_features

def linear_scale(series):
  return series.apply(lambda x: float(x-series.min())/(series.max()-series.min()))
...
Answer to A)  (60.75*((20-7)/(23-7)))+(20.63*0)+(-23.65*1)+(-3.02)

Answer to B)  (60.75*((5-7)/(23-7)))+(20.63*1)+(-23.65*0)+(-3.02)

Answer to C)  (60.75*((city_mpg-7)/(23-7)))+(20.63*1)+(-23.65*0)+(-3.02)

Answer to D)  (60.75*((city_mpg-7)/(23-7)))+(20.63*0)+(-23.65*1)+(-3.02)
...
y0=(60.75*x.min())+(20.63*1)+(-23.65*0)+(-3.02)
y1=(60.75*threshold)+(20.63*1)+(-23.65*0)+(-3.02)
